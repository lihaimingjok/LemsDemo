...
public class ViewFlow extends AdapterView<Adapter> {
    ...
    private ViewPager conflictPager;// 与这个控件滑动事件相冲突的viewPager,用以去除滑动冲突

    public void setConflictViewPager(ViewPager viewPager) {
        conflictPager = viewPager;
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (conflictPager != null)
                    conflictPager.requestDisallowInterceptTouchEvent(true);// 去除滑动冲突
            /*
            ...
            case MotionEvent.ACTION_UP:
                if (conflictPager != null)
                    conflictPager.requestDisallowInterceptTouchEvent(false);
