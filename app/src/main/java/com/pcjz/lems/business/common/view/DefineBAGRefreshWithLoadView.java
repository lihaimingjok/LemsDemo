...
public class DefineBAGRefreshWithLoadView extends BGARefreshViewHolder {
    ...
    public void hideLoadingMoreImg() {
        mRegGif.setVisibility(View.GONE);
    }
    ...
    public void showLoadingMoreImg() {
        mRegGif.setVisibility(View.VISIBLE);
    }
    ...
    public View getLoadMoreFooterView() {
        ...
        if (this.mLoadMoreFooterView == null) {
            ...
            mRegGif = (ProgressBar) mLoadMoreFooterView.findViewById(R.id.reg_req_code_gif_view);
