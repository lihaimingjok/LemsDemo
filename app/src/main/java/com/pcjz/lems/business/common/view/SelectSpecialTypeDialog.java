...
public class SelectSpecialTypeDialog  extends Dialog{
    ...
    public SelectSpecialTypeDialog(@NonNull Context context, SelectDialogEntity mSelectType, DataBackListener listener) {
    ...
    public SelectSpecialTypeDialog(@NonNull Context context) {
        super(context);
    }

    public SelectSpecialTypeDialog(@NonNull Context context, @StyleRes int themeResId) {
        super(context, themeResId);
    }

    public SelectSpecialTypeDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
    ...
    private void initView() {
        TextView tvTitle = (TextView) findViewById(R.id.tv_select_title);
