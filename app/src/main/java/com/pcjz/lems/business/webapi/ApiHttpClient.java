...
public class ApiHttpClient {
	...
	private final static String HOST = "172.16.12.150";//172.16.12.150
	...
	public static void resetHttpClient(/*AsyncHttpClient c*/) {
		...
		client.addHeader("Host", HOST);
		client.addHeader("Connection", "Keep-Alive");
		client.addHeader("application1",SharedPreferencesManager.getString(ResultStatus.TOKEN));
		client.addHeader("application2", SharedPreferencesManager.getString(ResultStatus.COMPANY_CODE));
		client.addHeader("application3","android-v1.0");
		client.addHeader("application4",SharedPreferencesManager.getString(ResultStatus.PHONE));
		client.addHeader("application5",SharedPreferencesManager.getString(ResultStatus.USER_ID));
