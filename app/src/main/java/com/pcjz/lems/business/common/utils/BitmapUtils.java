...
public class BitmapUtils {
    ...
    public static Bitmap compressImage(Bitmap image) {
        ...
        int options = 100;
        if (BitmapUtils.getBitmapSize(image) > 1024*1024*8) {
            options = 10;
        } if (BitmapUtils.getBitmapSize(image) > 1024*1024*4) {
            options = 20;
        } else if (BitmapUtils.getBitmapSize(image) > 1024*1024*3) {
            options = 30;
        } else if (BitmapUtils.getBitmapSize(image) > 1024*1024*1) {
            options = 50;
        }
