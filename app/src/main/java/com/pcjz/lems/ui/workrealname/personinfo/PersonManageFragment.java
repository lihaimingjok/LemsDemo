...
public class PersonManageFragment extends BaseFragment implements BGARefreshLayout.BGARefreshLayoutDelegate{
    ...
    List<PersonEntity> mDatas = new ArrayList<>();
    ...
    private void initBGARefreshLayout() {
        ...
        mAdapter = new PersonInfoAdapter(getActivity(), mDatas);
        ...
        mAdapter.setOnDialListener(new PersonInfoAdapter.onDialListener(){
            ...
            public void onDialPhone(View holder, int position) {
                String mPhone = mDatas.get(position).getPhoneNum();
    ...
    private void firstLoadData(int currentPage) {
        ...
        if(currentPage <= maxPage){
            ...
            MainApi.requestCommon(getActivity(), AppConfig.GET_PERSON_PAGE, entity, new AsyncHttpResponseHandler() {
                ...
                public void onSuccess(int i, Header[] headers, byte[] bytes) {
                    ...
                    TLog.log("managePerson -->"+httpResult);
                    try {
