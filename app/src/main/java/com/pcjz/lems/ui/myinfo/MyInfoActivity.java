...
import com.pcjz.lems.business.common.view.SelectPhotoPopupWindow;
...
/**
 * created by yezhengyu on 2017/4/10 17:40
 */
public class MyInfoActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        tvCompany = (TextView) findViewById(R.id.tv_person_company);
        initViewDatas();
    }
    ...
    private void initViewDatas() {
        ...
        String company = SharedPreferencesManager.getString(ResultStatus.COMPANY);
        ...
        tvPersonPlace.setText(postName);
    ...
    private void requestChangePortrait(HttpEntity entity) {
        MainApi.requestCommon(MyInfoActivity.this, AppConfig.USER_MOD_URL, entity, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int i, Header[] headers, byte[] bytes) {
                try {
                    String httpResult = new String(bytes);
